package app.mct.config.timezone;

import app.mct.MctApp;
import app.mct.repository.timezone.DateTimeWrapper;
import app.mct.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM mct_date_time_wrapper where id=%d", fieldName, id);
    }
