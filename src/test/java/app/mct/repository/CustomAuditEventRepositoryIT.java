...
import app.mct.config.audit.AuditEventConverter;
import app.mct.domain.PersistentAuditEvent;
...
import static app.mct.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
